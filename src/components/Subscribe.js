    ...
    return (
        ...
        <div className="subsribe-div py-5">
            <div className="container">
                <h6 className="text-center text-white" data-aos="fade-down"> Say Connect </h6>
                <h2 className="text-center text-white" data-aos="fade-up"> Join Our Mailing List </h2>
                <p className="text-center text-white" data-aos="fade-down"> By signing up, you agree to the Privacy Policy and you will be receiving our newsletters.</p>
