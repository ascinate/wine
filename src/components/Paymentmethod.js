    ...
    return(
        ...
        <div className="payment-sec mt-4">
            ...
            <div className="custom-control custom-radio">
                <input type="radio" id="customRadiocash" value='s' name="customRadio" className="custom-control-input" checked/>
                <label className="custom-control-label ms-2" for="customRadiocash">
                cash on delivery </label>
            </div>
            <div className="custom-control custom-radio">
            <input type="radio" onClick={()=>setShow(!show)} name="customRadio" className="custom-control-input"  />
            <label className="custom-control-label ms-2" for="customRadio1">Credit Crads /
                Debit Crads </label>
            </div>
            {
                show?<div className="account-page-n" id="ac-1">
